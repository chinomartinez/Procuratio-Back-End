...
{
    public class ItemDrinkCapacityXItemConfiguration : IEntityTypeConfiguration<ItemDrinkCapacityXItem>
    {
        public void Configure(EntityTypeBuilder<ItemDrinkCapacityXItem> builder)
        {
            builder.HasKey(x => new { x.ItemDrinkCapacityID, x.ItemID });
