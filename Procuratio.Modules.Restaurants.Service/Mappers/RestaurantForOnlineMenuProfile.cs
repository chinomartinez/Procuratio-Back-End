...
{
    public class RestaurantForOnlineMenuProfile : Profile
    {
        public RestaurantForOnlineMenuProfile()
        {
            CreateMap<RestaurantForOnlineMenuModel, RestaurantForOnlineMenuDTO>();
        }
    }
}
