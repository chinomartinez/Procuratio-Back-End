        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TableStateID1 = table.Column<short>(type: "smallint", nullable: true),
                    RestaurantID = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Table_TableState_TableStateID1",
                        column: x => x.TableStateID1,
                        principalSchema: "Orders",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Table_TableStateID1",
                schema: "Orders",
                table: "Table",
                column: "TableStateID1");
